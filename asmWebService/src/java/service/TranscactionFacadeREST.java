 ...
 */
@Stateless
@Path("entity.transcaction")
public class TranscactionFacadeREST extends AbstractFacade<Transaction> {

    @PersistenceContext(unitName = "asmWebServicePU")
    private EntityManager em;

    public TranscactionFacadeREST() {
